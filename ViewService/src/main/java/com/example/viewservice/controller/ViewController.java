...
public class ViewController {
    ...
    public String listGroups(Model model) {
        ...
        return "group/list"; // Имя HTML-шаблона
    }
    ...
    public String createStudentForm(@PathVariable Long groupId, Model model) {
        ...
        model.addAttribute("groupId", groupId); // Передаем groupId в шаблон
        return "student/create";
    }
    ...
    public String deleteStudent(@PathVariable Long id, @PathVariable Long groupId, Model model) {
